 ...
 */
{
  ...
  "seeCircle":      { "enabled": false, "thickness": 0.3, "alpha": 70, "color": "0x7DFF3D" },
  // Artillery gun fire range circle
  // Круг дальности стрельбы арты
  "rangeCircle":    { "enabled": false, "thickness": 0.3, "alpha": 70, "color": "0xEE4384" },
  // Fire range circle for some non artyllery tanks
  // Круг дальности стрельбы некоторых орудий обычных танков
  "rangeCircleGun": { "enabled": false, "thickness": 0.3, "alpha": 70, "color": "0x0000FF" },
  ...
  "circles": {
    ...
    { "enabled": true, "distance": 445, "thickness": 0.05, "alpha": 90,  "color": "0xFFFFFF" },
